// Package phaser Automatic generation for Phaser.Component.Crop
...
// ComponentCrop The Crop component provides the ability to crop a texture based Game Object to a defined rectangle, 
// which can be updated in real-time.
type ComponentCrop struct {
    *js.Object
}

// NewComponentCrop The Crop component provides the ability to crop a texture based Game Object to a defined rectangle, 
// which can be updated in real-time.
