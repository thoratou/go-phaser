// Package phaser Automatic generation for Phaser.Text
...
func NewText(game *Game, x int, y int, text string) *Text {
    return &Text{js.Global.Get("Phaser").Get("Text").New(game, x, y, text)}
}
...
func NewText1O(game *Game, x int, y int, text string, style interface{}) *Text {
    return &Text{js.Global.Get("Phaser").Get("Text").New(game, x, y, text, style)}
}
...
// Padding Specify a padding value which is added to the line width and height when calculating the Text size.
// ALlows you to add extra spacing if Phaser is unable to accurately determine the true font dimensions.
func (self *Text) Padding() *Point{
    return &Point{self.Object.Get("padding")}
}

// SetPaddingA Specify a padding value which is added to the line width and height when calculating the Text size.
// ALlows you to add extra spacing if Phaser is unable to accurately determine the true font dimensions.
func (self *Text) SetPaddingA(member *Point) {
    self.Object.Set("padding", member)
}

// TextBounds The textBounds property allows you to specify a rectangular region upon which text alignment is based.
// See `Text.setTextBounds` for more details.
func (self *Text) TextBounds() *Rectangle{
    return &Rectangle{self.Object.Get("textBounds")}
}

// SetTextBoundsA The textBounds property allows you to specify a rectangular region upon which text alignment is based.
// See `Text.setTextBounds` for more details.
...
// AutoRound Should the linePositionX and Y values be automatically rounded before rendering the Text?
...
// SetAutoRoundA Should the linePositionX and Y values be automatically rounded before rendering the Text?
// You may wish to enable this if you want to remove the effect of sub-pixel aliasing from text.
...
// Text The text to be displayed by this Text object.
...
// SetTextA The text to be displayed by this Text object.
// Use a \n to insert a carriage return and split the text.
// The text will be rendered with any style currently set.
...
// Align Controls the horizontal alignment for multiline text.
...
// SetAlignA Controls the horizontal alignment for multiline text.
// Can be: 'left', 'center' or 'right'.
// Does not affect single lines of text. For that please see `setTextBounds`.
...
// Resolution The resolution of the canvas the text is rendered to.
...
// SetResolutionA The resolution of the canvas the text is rendered to.
// This defaults to match the resolution of the renderer, but can be changed on a per Text object basis.
func (self *Text) SetResolutionA(member int) {
    self.Object.Set("resolution", member)
}

// Tabs The size (in pixels) of the tabs, for when text includes tab characters. 0 disables. 
...
// SetTabsA The size (in pixels) of the tabs, for when text includes tab characters. 0 disables. 
// Can be an integer or an array of varying tab sizes, one tab per element.
// For example if you set tabs to 100 then when Text encounters a tab it will jump ahead 100 pixels.
// If you set tabs to be `[100,200]` then it will set the first tab at 100px and the second at 200px.
...
// SetShadow1O Sets a drop shadow effect on the Text. You can specify the horizontal and vertical distance of the drop shadow with the `x` and `y` parameters.
// The color controls the shade of the shadow (default is black) and can be either an `rgba` or `hex` value.
// The blur is the strength of the shadow. A value of zero means a hard shadow, a value of 10 means a very soft shadow.
// To remove a shadow already in place you can call this method with no parameters set.
...
// SetShadow2O Sets a drop shadow effect on the Text. You can specify the horizontal and vertical distance of the drop shadow with the `x` and `y` parameters.
// The color controls the shade of the shadow (default is black) and can be either an `rgba` or `hex` value.
// The blur is the strength of the shadow. A value of zero means a hard shadow, a value of 10 means a very soft shadow.
// To remove a shadow already in place you can call this method with no parameters set.
...
// SetShadow3O Sets a drop shadow effect on the Text. You can specify the horizontal and vertical distance of the drop shadow with the `x` and `y` parameters.
// The color controls the shade of the shadow (default is black) and can be either an `rgba` or `hex` value.
// The blur is the strength of the shadow. A value of zero means a hard shadow, a value of 10 means a very soft shadow.
// To remove a shadow already in place you can call this method with no parameters set.
...
// SetShadow4O Sets a drop shadow effect on the Text. You can specify the horizontal and vertical distance of the drop shadow with the `x` and `y` parameters.
// The color controls the shade of the shadow (default is black) and can be either an `rgba` or `hex` value.
// The blur is the strength of the shadow. A value of zero means a hard shadow, a value of 10 means a very soft shadow.
// To remove a shadow already in place you can call this method with no parameters set.
...
// SetShadow5O Sets a drop shadow effect on the Text. You can specify the horizontal and vertical distance of the drop shadow with the `x` and `y` parameters.
// The color controls the shade of the shadow (default is black) and can be either an `rgba` or `hex` value.
// The blur is the strength of the shadow. A value of zero means a hard shadow, a value of 10 means a very soft shadow.
// To remove a shadow already in place you can call this method with no parameters set.
...
// SetShadow6O Sets a drop shadow effect on the Text. You can specify the horizontal and vertical distance of the drop shadow with the `x` and `y` parameters.
// The color controls the shade of the shadow (default is black) and can be either an `rgba` or `hex` value.
// The blur is the strength of the shadow. A value of zero means a hard shadow, a value of 10 means a very soft shadow.
// To remove a shadow already in place you can call this method with no parameters set.
...
// SetShadowI Sets a drop shadow effect on the Text. You can specify the horizontal and vertical distance of the drop shadow with the `x` and `y` parameters.
// The color controls the shade of the shadow (default is black) and can be either an `rgba` or `hex` value.
// The blur is the strength of the shadow. A value of zero means a hard shadow, a value of 10 means a very soft shadow.
// To remove a shadow already in place you can call this method with no parameters set.
...
// PrecalculateWordWrapI Runs the given text through the Text.runWordWrap function and returns
// the results as an array, where each element of the array corresponds to a wrapped
// line of text.
// 
// Useful if you wish to control pagination on long pieces of content.
...
// SetText1O The text to be displayed by this Text object.
// Use a \n to insert a carriage return and split the text.
// The text will be rendered with any style currently set.
// 
// Use the optional `immediate` argument if you need the Text display to update immediately.
...
// SetText2O The text to be displayed by this Text object.
// Use a \n to insert a carriage return and split the text.
// The text will be rendered with any style currently set.
// 
// Use the optional `immediate` argument if you need the Text display to update immediately.
...
// SetTextI The text to be displayed by this Text object.
// Use a \n to insert a carriage return and split the text.
// The text will be rendered with any style currently set.
// 
// Use the optional `immediate` argument if you need the Text display to update immediately.
...
// ParseListI Converts the given array into a tab delimited string and then updates this Text object.
// This is mostly used when you want to display external data using tab stops.
// 
// The array can be either single or multi dimensional depending on the result you need:
// 
...
// SetTextBounds1O The Text Bounds is a rectangular region that you control the dimensions of into which the Text object itself is positioned,
// regardless of the number of lines in the text, the font size or any other attribute.
// 
// Alignment is controlled via the properties `boundsAlignH` and `boundsAlignV` within the Text.style object, or can be directly
// set through the setters `Text.boundsAlignH` and `Text.boundsAlignV`. Bounds alignment is independent of text alignment.
...
// SetTextBounds2O The Text Bounds is a rectangular region that you control the dimensions of into which the Text object itself is positioned,
// regardless of the number of lines in the text, the font size or any other attribute.
// 
// Alignment is controlled via the properties `boundsAlignH` and `boundsAlignV` within the Text.style object, or can be directly
// set through the setters `Text.boundsAlignH` and `Text.boundsAlignV`. Bounds alignment is independent of text alignment.
...
// SetTextBounds3O The Text Bounds is a rectangular region that you control the dimensions of into which the Text object itself is positioned,
// regardless of the number of lines in the text, the font size or any other attribute.
// 
// Alignment is controlled via the properties `boundsAlignH` and `boundsAlignV` within the Text.style object, or can be directly
// set through the setters `Text.boundsAlignH` and `Text.boundsAlignV`. Bounds alignment is independent of text alignment.
...
// SetTextBounds4O The Text Bounds is a rectangular region that you control the dimensions of into which the Text object itself is positioned,
// regardless of the number of lines in the text, the font size or any other attribute.
// 
// Alignment is controlled via the properties `boundsAlignH` and `boundsAlignV` within the Text.style object, or can be directly
// set through the setters `Text.boundsAlignH` and `Text.boundsAlignV`. Bounds alignment is independent of text alignment.
...
// SetTextBoundsI The Text Bounds is a rectangular region that you control the dimensions of into which the Text object itself is positioned,
// regardless of the number of lines in the text, the font size or any other attribute.
// 
// Alignment is controlled via the properties `boundsAlignH` and `boundsAlignV` within the Text.style object, or can be directly
// set through the setters `Text.boundsAlignH` and `Text.boundsAlignV`. Bounds alignment is independent of text alignment.
