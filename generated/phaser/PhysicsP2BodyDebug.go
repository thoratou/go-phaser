...
func (self *PhysicsP2BodyDebug) Add(child *DisplayObject, silent bool, index int) *DisplayObject{
...
// 
// If `Group.inputEnableChildren` is set, then an Input Handler will be created on the object, so long as one does not already exist.
func (self *PhysicsP2BodyDebug) AddAt(child *DisplayObject, index int, silent bool) *DisplayObject{
...
func (self *PhysicsP2BodyDebug) AddMultiple(children interface{}, silent bool) interface{}{
...
// 
// If `Group.inputEnableChildren` is set, then an Input Handler will be created on the object, so long as one does not already exist.
func (self *PhysicsP2BodyDebug) Create(x int, y int, key interface{}, frame interface{}, exists bool, index int) *DisplayObject{
...
// 
// If `Group.inputEnableChildren` is set, then an Input Handler will be created on the objects, so long as one does not already exist.
func (self *PhysicsP2BodyDebug) CreateMultiple(quantity int, key interface{}, frame interface{}, exists bool) []interface{}{
...
func (self *PhysicsP2BodyDebug) Align(rows int, columns int, cellWidth int, cellHeight int, position int, offset int) {
...
func (self *PhysicsP2BodyDebug) ResetCursor(index int) interface{}{
...
func (self *PhysicsP2BodyDebug) SetProperty(child interface{}, key []interface{}, value interface{}, operation int, force bool) bool{
...
func (self *PhysicsP2BodyDebug) CheckProperty(child interface{}, key []interface{}, value interface{}, force bool) bool{
...
func (self *PhysicsP2BodyDebug) Set(child *Sprite, key string, value interface{}, checkAlive bool, checkVisible bool, operation int, force bool) bool{
...
// 
// The operation parameter controls how the new value is assigned to the property, from simple replacement to addition and multiplication.
func (self *PhysicsP2BodyDebug) SetAll(key string, value interface{}, checkAlive bool, checkVisible bool, operation int, force bool) {
...
// 
// The operation parameter controls how the new value is assigned to the property, from simple replacement to addition and multiplication.
func (self *PhysicsP2BodyDebug) SetAllChildren(key string, value interface{}, checkAlive bool, checkVisible bool, operation int, force bool) {
...
func (self *PhysicsP2BodyDebug) CheckAll(key string, value interface{}, checkAlive bool, checkVisible bool, force bool) {
...
func (self *PhysicsP2BodyDebug) Filter(predicate func(...interface{}), checkExists bool) *ArraySet{
...
func (self *PhysicsP2BodyDebug) ForEach(callback func(...interface{}), callbackContext interface{}, checkExists bool, args interface{}) {
...
func (self *PhysicsP2BodyDebug) ForEachExists(callback func(...interface{}), callbackContext interface{}, args interface{}) {
...
// 
// See {@link Phaser.Group#forEach forEach} for details.
func (self *PhysicsP2BodyDebug) ForEachAlive(callback func(...interface{}), callbackContext interface{}, args interface{}) {
...
// 
// See {@link Phaser.Group#forEach forEach} for details.
func (self *PhysicsP2BodyDebug) ForEachDead(callback func(...interface{}), callbackContext interface{}, args interface{}) {
...
func (self *PhysicsP2BodyDebug) Sort(key string, order int) {
...
func (self *PhysicsP2BodyDebug) CustomSort(sortHandler func(...interface{}), context interface{}) {
...
func (self *PhysicsP2BodyDebug) Iterate(key string, value interface{}, returnType int, callback func(...interface{}), callbackContext interface{}, args []interface{}) interface{}{
...
func (self *PhysicsP2BodyDebug) GetFirstExists(exists bool, createIfNull bool, x int, y int, key interface{}, frame interface{}) *DisplayObject{
...
// If a child *was* found , `createIfNull` is `false` and you provided the additional arguments then the child
// will be reset and/or have a new texture loaded on it. This is handled by `Group.resetChild`.
func (self *PhysicsP2BodyDebug) GetFirstAlive(createIfNull bool, x int, y int, key interface{}, frame interface{}) *DisplayObject{
...
// If a child *was* found , `createIfNull` is `false` and you provided the additional arguments then the child
// will be reset and/or have a new texture loaded on it. This is handled by `Group.resetChild`.
func (self *PhysicsP2BodyDebug) GetFirstDead(createIfNull bool, x int, y int, key interface{}, frame interface{}) *DisplayObject{
...
func (self *PhysicsP2BodyDebug) ResetChild(child *DisplayObject, x int, y int, key interface{}, frame interface{}) *DisplayObject{
...
func (self *PhysicsP2BodyDebug) GetClosestTo(object interface{}, callback func(...interface{}), callbackContext interface{}) interface{}{
...
// with the distance as the second. The callback should return `true` if it passes your 
// filtering criteria, otherwise it should return `false`.
func (self *PhysicsP2BodyDebug) GetFurthestFrom(object interface{}, callback func(...interface{}), callbackContext interface{}) interface{}{
...
func (self *PhysicsP2BodyDebug) GetRandom(startIndex int, length int) interface{}{
...
func (self *PhysicsP2BodyDebug) Remove(child interface{}, destroy bool, silent bool) bool{
...
func (self *PhysicsP2BodyDebug) MoveAll(group *Group, silent bool) *Group{
...
func (self *PhysicsP2BodyDebug) RemoveAll(destroy bool, silent bool, destroyTexture bool) {
...
func (self *PhysicsP2BodyDebug) RemoveBetween(startIndex int, endIndex int, destroy bool, silent bool) {
...
func (self *PhysicsP2BodyDebug) Destroy(destroyChildren bool, soft bool) {
...
// one expands it.
func (self *PhysicsP2BodyDebug) AlignIn(container interface{}, position int, offsetX int, offsetY int) *Group{
...
// one expands it.
func (self *PhysicsP2BodyDebug) AlignTo(parent interface{}, position int, offsetX int, offsetY int) *Group{
