...
func (self *Group) Add(child *DisplayObject, silent bool, index int) *DisplayObject{
...
// 
// If `Group.inputEnableChildren` is set, then an Input Handler will be created on the object, so long as one does not already exist.
func (self *Group) AddAt(child *DisplayObject, index int, silent bool) *DisplayObject{
...
func (self *Group) AddMultiple(children interface{}, silent bool) interface{}{
...
// 
// If `Group.inputEnableChildren` is set, then an Input Handler will be created on the object, so long as one does not already exist.
func (self *Group) Create(x int, y int, key interface{}, frame interface{}, exists bool, index int) *DisplayObject{
...
// 
// If `Group.inputEnableChildren` is set, then an Input Handler will be created on the objects, so long as one does not already exist.
func (self *Group) CreateMultiple(quantity int, key interface{}, frame interface{}, exists bool) []interface{}{
...
func (self *Group) Align(rows int, columns int, cellWidth int, cellHeight int, position int, offset int) {
...
func (self *Group) ResetCursor(index int) interface{}{
...
func (self *Group) SetProperty(child interface{}, key []interface{}, value interface{}, operation int, force bool) bool{
...
func (self *Group) CheckProperty(child interface{}, key []interface{}, value interface{}, force bool) bool{
...
func (self *Group) Set(child *Sprite, key string, value interface{}, checkAlive bool, checkVisible bool, operation int, force bool) bool{
...
// 
// The operation parameter controls how the new value is assigned to the property, from simple replacement to addition and multiplication.
func (self *Group) SetAll(key string, value interface{}, checkAlive bool, checkVisible bool, operation int, force bool) {
...
// 
// The operation parameter controls how the new value is assigned to the property, from simple replacement to addition and multiplication.
func (self *Group) SetAllChildren(key string, value interface{}, checkAlive bool, checkVisible bool, operation int, force bool) {
...
func (self *Group) CheckAll(key string, value interface{}, checkAlive bool, checkVisible bool, force bool) {
...
func (self *Group) Filter(predicate func(...interface{}), checkExists bool) *ArraySet{
...
func (self *Group) ForEach(callback func(...interface{}), callbackContext interface{}, checkExists bool, args interface{}) {
...
func (self *Group) ForEachExists(callback func(...interface{}), callbackContext interface{}, args interface{}) {
...
// 
// See {@link Phaser.Group#forEach forEach} for details.
func (self *Group) ForEachAlive(callback func(...interface{}), callbackContext interface{}, args interface{}) {
...
// 
// See {@link Phaser.Group#forEach forEach} for details.
func (self *Group) ForEachDead(callback func(...interface{}), callbackContext interface{}, args interface{}) {
...
func (self *Group) Sort(key string, order int) {
...
func (self *Group) CustomSort(sortHandler func(...interface{}), context interface{}) {
...
func (self *Group) Iterate(key string, value interface{}, returnType int, callback func(...interface{}), callbackContext interface{}, args []interface{}) interface{}{
...
func (self *Group) GetFirstExists(exists bool, createIfNull bool, x int, y int, key interface{}, frame interface{}) *DisplayObject{
...
// If a child *was* found , `createIfNull` is `false` and you provided the additional arguments then the child
// will be reset and/or have a new texture loaded on it. This is handled by `Group.resetChild`.
func (self *Group) GetFirstAlive(createIfNull bool, x int, y int, key interface{}, frame interface{}) *DisplayObject{
...
// If a child *was* found , `createIfNull` is `false` and you provided the additional arguments then the child
// will be reset and/or have a new texture loaded on it. This is handled by `Group.resetChild`.
func (self *Group) GetFirstDead(createIfNull bool, x int, y int, key interface{}, frame interface{}) *DisplayObject{
...
func (self *Group) ResetChild(child *DisplayObject, x int, y int, key interface{}, frame interface{}) *DisplayObject{
...
func (self *Group) GetClosestTo(object interface{}, callback func(...interface{}), callbackContext interface{}) interface{}{
...
// with the distance as the second. The callback should return `true` if it passes your 
// filtering criteria, otherwise it should return `false`.
func (self *Group) GetFurthestFrom(object interface{}, callback func(...interface{}), callbackContext interface{}) interface{}{
...
func (self *Group) GetRandom(startIndex int, length int) interface{}{
...
func (self *Group) Remove(child interface{}, destroy bool, silent bool) bool{
...
func (self *Group) MoveAll(group *Group, silent bool) *Group{
...
func (self *Group) RemoveAll(destroy bool, silent bool, destroyTexture bool) {
...
func (self *Group) RemoveBetween(startIndex int, endIndex int, destroy bool, silent bool) {
...
func (self *Group) Destroy(destroyChildren bool, soft bool) {
...
// one expands it.
func (self *Group) AlignIn(container interface{}, position int, offsetX int, offsetY int) *Group{
...
// one expands it.
func (self *Group) AlignTo(parent interface{}, position int, offsetX int, offsetY int) *Group{
