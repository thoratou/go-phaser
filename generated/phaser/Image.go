...
func (self *Image) SetTexture(texture *Texture, destroy bool) {
...
func (self *Image) _renderWebGL(renderSession *RenderSession, matrix *Matrix) {
...
func (self *Image) _renderCanvas(renderSession *RenderSession, matrix *Matrix) {
...
func (self *Image) Play(name string, frameRate int, loop bool, killOnComplete bool) *Animation{
...
// one expands it.
func (self *Image) AlignIn(container interface{}, position int, offsetX int, offsetY int) interface{}{
...
// one expands it.
func (self *Image) AlignTo(parent interface{}, position int, offsetX int, offsetY int) interface{}{
...
func (self *Image) Crop(rect *Rectangle, copy bool) {
...
func (self *Image) Destroy(destroyChildren bool, destroyTexture bool) {
...
func (self *Image) Revive(health int) *DisplayObject{
...
func (self *Image) LoadTexture(key interface{}, frame interface{}, stopAnimation bool) {
...
func (self *Image) Reset(x int, y int, health int) *DisplayObject{
