...
// Stage The stage that this DisplayObject is connected to.
func (self *DisplayObject) Stage() *PIXIStage{
    return &PIXIStage{self.Object.Get("stage")}
}

// SetStageA The stage that this DisplayObject is connected to.
