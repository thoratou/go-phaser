...
func (self *Sprite) GetAnchor() *Point{
...
// Setting than anchor to 0.5,0.5 means the textures origin is centered
// Setting the anchor to 1,1 would mean the textures origin points will be the bottom right corner
func (self *Sprite) SetAnchor(member *Point) {
    self.Set("anchor", member)
}

// The texture that the sprite is using
func (self *Sprite) GetTexture() *Texture{
    return &Texture{self.Get("texture")}
}

// The texture that the sprite is using
func (self *Sprite) SetTexture(member *Texture) {
...
func (self *Sprite) GetTintedTexture() *Canvas{
    return &Canvas{self.Get("tintedTexture")}
}

// A canvas that contains the tinted version of the Sprite (in Canvas mode, WebGL doesn't populate this)
func (self *Sprite) SetTintedTexture(member *Canvas) {
...
func (self *Sprite) GetShader() *AbstractFilter{
    return &AbstractFilter{self.Get("shader")}
}

// The shader that will be used to render the texture to the stage. Set to null to remove a current shader.
func (self *Sprite) SetShader(member *AbstractFilter) {
    self.Set("shader", member)
}

// Controls if this Sprite is processed by the core Phaser game loops and Group loops.
func (self *Sprite) GetExists() bool{
    return self.Get("exists").Bool()
}

// Controls if this Sprite is processed by the core Phaser game loops and Group loops.
func (self *Sprite) SetExists(member bool) {
...
func (self *Sprite) GetChildren() []DisplayObject{
...
// [read-only] The array of children of this container.
func (self *Sprite) SetChildren(member []DisplayObject) {
...
func (self *Sprite) GetIgnoreChildInput() bool{
...
// 
// Note that this property isn't recursive: only immediate children are influenced, it doesn't scan further down.
func (self *Sprite) SetIgnoreChildInput(member bool) {
    self.Set("ignoreChildInput", member)
}

// A reference to the currently running Game.
func (self *Sprite) GetGame() *Game{
    return &Game{self.Get("game")}
}

// A reference to the currently running Game.
func (self *Sprite) SetGame(member *Game) {
    self.Set("game", member)
}

// A user defined name given to this Game Object.
// This value isn't ever used internally by Phaser, it is meant as a game level property.
func (self *Sprite) GetName() string{
    return self.Get("name").String()
}

// A user defined name given to this Game Object.
// This value isn't ever used internally by Phaser, it is meant as a game level property.
func (self *Sprite) SetName(member string) {
...
func (self *Sprite) GetData() interface{}{
...
// by Phaser Plugins, to store data that needs to be associated with the Game Object,
// without polluting the Game Object directly.
func (self *Sprite) SetData(member interface{}) {
    self.Set("data", member)
}

// The components this Game Object has installed.
func (self *Sprite) GetComponents() interface{}{
    return self.Get("components")
}

// The components this Game Object has installed.
func (self *Sprite) SetComponents(member interface{}) {
...
func (self *Sprite) GetEvents() *Events{
    return &Events{self.Get("events")}
}

// All Phaser Game Objects have an Events class which contains all of the events that are dispatched when certain things happen to this
// Game Object, or any of its components.
func (self *Sprite) SetEvents(member *Events) {
    self.Set("events", member)
}

// If the Game Object is enabled for animation (such as a Phaser.Sprite) this is a reference to its AnimationManager instance.
// Through it you can create, play, pause and stop animations.
func (self *Sprite) GetAnimations() *AnimationManager{
    return &AnimationManager{self.Get("animations")}
}

// If the Game Object is enabled for animation (such as a Phaser.Sprite) this is a reference to its AnimationManager instance.
// Through it you can create, play, pause and stop animations.
func (self *Sprite) SetAnimations(member *AnimationManager) {
...
func (self *Sprite) GetKey() interface{}{
    return self.Get("key")
}
...
// If a Game Object is created without a key it is automatically assigned the key `__default` which is a 32x32 transparent PNG stored within the Cache.
// If a Game Object is given a key which doesn't exist in the Image Cache it is re-assigned the key `__missing` which is a 32x32 PNG of a green box with a line through it.
func (self *Sprite) SetKey(member interface{}) {
    self.Set("key", member)
}
...
func (self *Sprite) GetWorld() *Point{
...
// Depending on where in the display list this Game Object is placed this value can differ from `position`, 
// which contains the x/y coordinates relative to the Game Objects parent.
func (self *Sprite) SetWorld(member *Point) {
    self.Set("world", member)
}

// A debug flag designed for use with `Game.enableStep`.
func (self *Sprite) GetDebug() bool{
    return self.Get("debug").Bool()
}

// A debug flag designed for use with `Game.enableStep`.
func (self *Sprite) SetDebug(member bool) {
    self.Set("debug", member)
}

// The position the Game Object was located in the previous frame.
func (self *Sprite) GetPreviousPosition() *Point{
    return &Point{self.Get("previousPosition")}
}

// The position the Game Object was located in the previous frame.
func (self *Sprite) SetPreviousPosition(member *Point) {
...
func (self *Sprite) GetFresh() bool{
    return self.Get("fresh").Bool()
}

// A Game Object is considered `fresh` if it has just been created or reset and is yet to receive a renderer transform update.
// This property is mostly used internally by the physics systems, but is exposed for the use of plugins.
func (self *Sprite) SetFresh(member bool) {
...
func (self *Sprite) GetPendingDestroy() bool{
...
// This is extremely useful if you wish to destroy an object from within one of its own callbacks 
// such as with Buttons or other Input events.
func (self *Sprite) SetPendingDestroy(member bool) {
...
func (self *Sprite) GetAutoCull() bool{
...
// This is a relatively expensive operation, especially if enabled on hundreds of Game Objects. So enable it only if you know it's required,
// or you have tested performance and find it acceptable.
func (self *Sprite) SetAutoCull(member bool) {
    self.Set("autoCull", member)
}

// Checks if the Game Objects bounds intersect with the Game Camera bounds.
// Returns `true` if they do, otherwise `false` if fully outside of the Cameras bounds.
func (self *Sprite) GetInCamera() bool{
    return self.Get("inCamera").Bool()
}

// Checks if the Game Objects bounds intersect with the Game Camera bounds.
// Returns `true` if they do, otherwise `false` if fully outside of the Cameras bounds.
func (self *Sprite) SetInCamera(member bool) {
...
func (self *Sprite) GetCropRect() *Rectangle{
...
// Set this property via `crop`. 
// If you modify this property directly you must call `updateCrop` in order to have the change take effect.
func (self *Sprite) SetCropRect(member *Rectangle) {
...
func (self *Sprite) GetDestroyPhase() bool{
    return self.Get("destroyPhase").Bool()
}

// As a Game Object runs through its destroy method this flag is set to true, 
// and can be checked in any sub-systems or plugins it is being destroyed from.
func (self *Sprite) SetDestroyPhase(member bool) {
...
func (self *Sprite) GetFixedToCamera() bool{
...
// 
// Be careful not to set `fixedToCamera` on Game Objects which are in Groups that already have `fixedToCamera` enabled on them.
func (self *Sprite) SetFixedToCamera(member bool) {
...
func (self *Sprite) GetCameraOffset() *Point{
...
// 
// The values are relative to the top-left of the camera view and in addition to any parent of the Game Object on the display list.
func (self *Sprite) SetCameraOffset(member *Point) {
...
func (self *Sprite) GetDamage() interface{}{
...
// 
// If health is taken below or is equal to zero then the `kill` method is called.
func (self *Sprite) SetDamage(member interface{}) {
...
func (self *Sprite) GetSetHealth() interface{}{
    return self.Get("setHealth")
}

// Sets the health property of the Game Object to the given amount.
// Will never exceed the `maxHealth` value.
func (self *Sprite) SetSetHealth(member interface{}) {
    self.Set("setHealth", member)
}

// Heal the Game Object. This adds the given amount of health to the `health` property.
func (self *Sprite) GetHeal() interface{}{
    return self.Get("heal")
}

// Heal the Game Object. This adds the given amount of health to the `health` property.
func (self *Sprite) SetHeal(member interface{}) {
...
func (self *Sprite) GetInput() interface{}{
...
// 
// After you have done this, this property will be a reference to the Phaser InputHandler.
func (self *Sprite) SetInput(member interface{}) {
...
func (self *Sprite) GetInputEnabled() bool{
...
// `input.enabled = false`, as it won't reset any of the Input Handlers internal properties.
// You can then toggle this back on as needed.
func (self *Sprite) SetInputEnabled(member bool) {
...
// This is a relatively expensive operation, especially if enabled on hundreds of Game Objects. So enable it only if you know it's required,
// or you have tested performance and find it acceptable.
func (self *Sprite) GetCheckWorldBounds() bool{
...
func (self *Sprite) GetAlive() bool{
...
// This property is mostly just provided to be used by your game - it doesn't effect rendering or logic updates.
// However you can use `Group.getFirstAlive` in conjunction with this property for fast object pooling and recycling.
func (self *Sprite) SetAlive(member bool) {
...
// 
// If you wish to fully replace the texture being used see `loadTexture`.
func (self *Sprite) SetFrame(member int) {
...
// 
// If you wish to fully replace the texture being used see `loadTexture`.
func (self *Sprite) GetFrameName() string{
...
// 
// If you wish to fully replace the texture being used see `loadTexture`.
func (self *Sprite) SetFrameName(member string) {
...
func (self *Sprite) GetBody() interface{}{
...
// 
// If you need a different result then adjust or re-create the Body shape offsets manually or reset the anchor after enabling physics.
func (self *Sprite) SetBody(member interface{}) {
...
func (self *Sprite) SetTransformCallback(member func(...interface{})) {
    self.Set("transformCallback", member)
}

// The context under which `transformCallback` is called.
func (self *Sprite) GetTransformCallbackContext() interface{}{
    return self.Get("transformCallbackContext")
}

// The context under which `transformCallback` is called.
func (self *Sprite) SetTransformCallbackContext(member interface{}) {
...
func (self *Sprite) GetScaleMin() *Point{
...
// 
// Set it to `null` to remove the limit.
func (self *Sprite) SetScaleMin(member *Point) {
...
// 
// Set it to `null` to remove the limit.
func (self *Sprite) GetScaleMax() *Point{
...
// 
// Set it to `null` to remove the limit.
func (self *Sprite) SetScaleMax(member *Point) {
...
func (self *Sprite) GetSmoothed() bool{
...
// 
// Smoothing is enabled by default.
func (self *Sprite) SetSmoothed(member bool) {
