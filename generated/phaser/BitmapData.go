...
func (self *BitmapData) Move(x int, y int, wrap bool) *BitmapData{
...
func (self *BitmapData) MoveH(distance int, wrap bool) *BitmapData{
...
// 
// The image will wrap-around the sides if the wrap argument is true (the default).
func (self *BitmapData) MoveV(distance int, wrap bool) *BitmapData{
...
func (self *BitmapData) Clear(x int, y int, width int, height int) *BitmapData{
...
func (self *BitmapData) Fill(r int, g int, b int, a int) *BitmapData{
...
func (self *BitmapData) Update(x int, y int, width int, height int) *BitmapData{
...
func (self *BitmapData) ProcessPixelRGB(callback func(...interface{}), callbackContext interface{}, x int, y int, width int, height int) *BitmapData{
...
// The callback will also be sent the pixels x and y coordinates respectively.
func (self *BitmapData) ProcessPixel(callback func(...interface{}), callbackContext interface{}, x int, y int, width int, height int) *BitmapData{
...
func (self *BitmapData) ReplaceRGB(r1 int, g1 int, b1 int, a1 int, r2 int, g2 int, b2 int, a2 int, region *Rectangle) *BitmapData{
...
func (self *BitmapData) SetHSL(h int, s int, l int, region *Rectangle) *BitmapData{
...
func (self *BitmapData) ShiftHSL(h int, s int, l int, region *Rectangle) *BitmapData{
...
func (self *BitmapData) SetPixel32(x int, y int, red int, green int, blue int, alpha int, immediate bool) *BitmapData{
...
func (self *BitmapData) SetPixel(x int, y int, red int, green int, blue int, immediate bool) *BitmapData{
...
func (self *BitmapData) GetPixel(x int, y int, out interface{}) interface{}{
...
// If you have drawn anything to the BitmapData since it was created you must call BitmapData.update to refresh the array buffer,
// otherwise this may return out of date color values, or worse - throw a run-time error as it tries to access an array element that doesn't exist.
func (self *BitmapData) GetPixelRGB(x int, y int, out interface{}, hsl bool, hsv bool) interface{}{
...
// 2 = left to right
// 3 = right to left
func (self *BitmapData) GetFirstPixel(direction int) interface{}{
...
func (self *BitmapData) GetBounds(rect *Rectangle) *Rectangle{
...
func (self *BitmapData) AddToWorld(x int, y int, anchorX int, anchorY int, scaleX int, scaleY int) *Image{
...
func (self *BitmapData) Copy(source interface{}, x int, y int, width int, height int, tx int, ty int, newWidth int, newHeight int, rotate int, anchorX int, anchorY int, scaleX int, scaleY int, alpha int, blendMode string, roundPx bool) *BitmapData{
...
func (self *BitmapData) CopyTransform(source interface{}, blendMode string, roundPx bool) *BitmapData{
...
func (self *BitmapData) CopyRect(source interface{}, area *Rectangle, x int, y int, alpha int, blendMode string, roundPx bool) *BitmapData{
...
func (self *BitmapData) Draw(source interface{}, x int, y int, width int, height int, blendMode string, roundPx bool) *BitmapData{
...
func (self *BitmapData) DrawGroup(group *Group, blendMode string, roundPx bool) *BitmapData{
...
func (self *BitmapData) DrawGroupProxy(child interface{}, blendMode string, roundPx bool) {
...
func (self *BitmapData) DrawFull(parent interface{}, blendMode string, roundPx bool) *BitmapData{
...
func (self *BitmapData) Shadow(color string, blur int, x int, y int) *BitmapData{
...
func (self *BitmapData) AlphaMask(source interface{}, mask interface{}, sourceRect *Rectangle, maskRect *Rectangle) *BitmapData{
...
func (self *BitmapData) Extract(destination *BitmapData, r int, g int, b int, a int, resize bool, r2 int, g2 int, b2 int) *BitmapData{
...
func (self *BitmapData) Rect(x int, y int, width int, height int, fillStyle string) *BitmapData{
...
func (self *BitmapData) Text(text string, x int, y int, font string, color string, shadow bool) *BitmapData{
...
func (self *BitmapData) Circle(x int, y int, radius int, fillStyle string) *BitmapData{
...
func (self *BitmapData) Line(x1 int, y1 int, x2 int, y2 int, color string, width int) *BitmapData{
...
func (self *BitmapData) TextureLine(line *Line, image interface{}, repeat string) *BitmapData{
